...
if (isset($_POST['pseudo']) and isset($_POST['message'])) {
    ...
    $_POST['pseudo'] = htmlspecialchars($_POST['pseudo']); // $_POST['pseudo'] = strip_tags($_POST['pseudo']);    
    $_POST['message'] = strip_tags($_POST['message']); // supprimer toutes les balises html // $_POST['message'] = htmlspecialchars($_POST['message']);
...
// Puis rediriger vers minichat_d.php comme ceci :
header('Location: minichat_d.php');
